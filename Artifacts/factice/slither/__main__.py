...
from slither.utils import solc_version
...
def main_impl(
    ...
    try:
        ...
        # # 根据file中solidity的版本号，使用python下载并切换到对应的solidity版本
        # required_solc_version = solc_version.get_target_solc_version(filename)
        # if required_solc_version:
        #     solc_version.set_solc_version(required_solc_version)
